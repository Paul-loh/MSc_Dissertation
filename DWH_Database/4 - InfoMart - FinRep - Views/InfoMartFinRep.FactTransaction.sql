CREATE VIEW [InfoMartFinRep].[FactTransaction]
	AS 
	
--	Author:				Paul Loh	
--	Creation Date:		20191122
--	Description:		Fact Table in Finrep (Financial Reporting) Information Mart.
--
--						Grain: Transaction Number

--		Changes:
--						20191220	-	Paul Loh	-	Added transaction analysis mappings (used to categorise cash flow types in Modified Dietz \ Movement measures ) 
...
SELECT		
	...
	--	Retrieve last loaded satellite attributes for transaction fact dimensions 
		...
		AND				lt.Meta_LoadDateTime		BETWEEN		ss.Meta_LoadDateTime 
		...
		AND				lt.Meta_LoadDateTime		BETWEEN		sp.Meta_LoadDateTime 
		...
		AND				lt.Meta_LoadDateTime		BETWEEN		sb.Meta_LoadDateTime 
		...
		AND				lt.Meta_LoadDateTime		BETWEEN		spc.Meta_LoadDateTime 
		...
		AND				lt.Meta_LoadDateTime		BETWEEN		ssc.Meta_LoadDateTime 
		...
		AND				lt.Meta_LoadDateTime		BETWEEN		rtm.Meta_LoadDateTime 
