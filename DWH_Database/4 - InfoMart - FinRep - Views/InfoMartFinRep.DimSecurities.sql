CREATE VIEW [InfoMartFinRep].[DimSecurities]
AS 
...
--						Grain: Security | Load DateTime
	...
	AND				ss.Meta_LoadDateTime				BETWEEN		sih.Meta_LoadDateTime 
	...
	AND				ss.Meta_LoadDateTime				BETWEEN		srh.Meta_LoadDateTime 
	...
	AND				ss.Meta_LoadDateTime				BETWEEN		sah.Meta_LoadDateTime 
	...
	AND				ss.Meta_LoadDateTime				BETWEEN		sb.Meta_LoadDateTime 
