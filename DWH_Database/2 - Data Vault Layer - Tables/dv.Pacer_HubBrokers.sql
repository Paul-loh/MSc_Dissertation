...
(
	...
	[BrokerCode]						NVARCHAR (100) NOT NULL,

	CONSTRAINT [PK_HubBrokers]	PRIMARY KEY NONCLUSTERED ( [HKeyBroker] ),
	CONSTRAINT [UIX_HubBrokers]	UNIQUE CLUSTERED ( [BrokerCode] ASC )		-- Good practice to add a unique index constraint on Business Key columns
)
